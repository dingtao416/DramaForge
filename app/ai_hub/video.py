...
Available Models (by cost-effectiveness):
  ...
  │ Model ID                 │ API    │ Notes                       │
  ├──────────────────────────┼────────┼─────────────────────────────┤
  │ veo-3.1-fast             │ sync   │ ⭐ Best speed/quality ratio │
  │ veo-3.1                  │ sync   │ Highest quality (Veo 3.1)   │
  │ veo-3.1-landscape        │ sync   │ Landscape version           │
  │ veo-3.1-landscape-fast   │ sync   │ Landscape fast              │
  │ veo3-fast                │ sync   │ Veo 3 fast                  │
  │ veo3                     │ sync   │ Veo 3 standard              │
  │ veo3-pro                 │ sync   │ Veo 3 pro (best Veo qual)   │
  │ sora_video2              │ sync   │ Sora 2 portrait             │
  │ sora_video2-landscape    │ sync   │ Sora 2 landscape            │
  │ sora_video2-portrait     │ sync   │ Sora 2 portrait explicit    │
  │ sora_video2-15s          │ sync   │ Sora 2 portrait 15s         │
  │ sora_video2-landscape-15s│ sync   │ Sora 2 landscape 15s        │
  │ sora_video2-portrait-15s │ sync   │ Sora 2 portrait 15s         │
  │ sora-2-character         │ sync   │ Sora 2 character animation  │
  │ sora-2                   │ async  │ $0.15 (unstable under load) │
  │ sora-2-pro               │ async  │ $0.8, 1080P (async only)    │
  └──────────────────────────┴────────┴─────────────────────────────┘
